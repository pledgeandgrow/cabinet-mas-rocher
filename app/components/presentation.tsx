    ...
    return (
        <section className="py-12 px-6 md:px-12 lg:px-24">
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div>
                    <Badge className="mb-4 bg-[#8e2024] hover:bg-[#8e2024]/90 text-white">Le cabinet</Badge>
                    <h1 className="text-5xl font-bold mb-4">
                        Présent à Paris depuis 1952
                    </h1>
                    <p className="text-lg text-gray-500 mb-4">
                        Installé dans le Marais depuis 1952, le cabinet Mas Rocher assure aujourd’hui la gestion de plus de 200 copropriétés dans le centre de Paris et compte plus de 1500 lots en gestion locative.
                    </p>
                    <p className="text-lg text-gray-500 mb-4">
